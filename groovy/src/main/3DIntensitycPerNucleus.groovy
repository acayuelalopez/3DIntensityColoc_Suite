...
//
//
def inputFilesTrf1 = new File("/mnt/imgserver/CONFOCAL/IA/Projects/2025/2025_2_14_jfiel/output/telomere")
...
wtRt.saveAs(outputDir.getAbsolutePath() + File.separator + "csv" + File.separator + "3DAnalysis_WT_per_Nucleus.csv")
koRt.saveAs(outputDir.getAbsolutePath() + File.separator + "csv" + File.separator + "3DAnalysis_KO_per_Nucleus.csv")
